...
public interface NotificationService {
	...
	void dsaKycConfirmationMail(String to, String kycId, String dsaId, String dsaName, String contact, String address,
			List<String> docs, List<Path> storedFilePaths);
